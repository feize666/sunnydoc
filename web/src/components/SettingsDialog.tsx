    ...
    <div className="dialog-overlay" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between border-b border-line px-5 py-3.5">
          <div className="text-[14px] font-semibold text-text">设置</div>
          <button
            onClick={onClose}
        ...
        <div className="px-5 py-4">
          ...
          <div className="mt-2 flex items-center justify-between rounded-lg border border-line bg-surface px-3 py-2.5">
            <div>
              <div className="text-[13px] text-text">主题</div>
          ...
          <div className="mt-4 text-[12px] font-semibold text-muted">语言</div>
          <div className="mt-2 flex items-center justify-between rounded-lg border border-line bg-surface px-3 py-2.5">
            <span className="text-[13px] text-text">简体中文</span>
            <span className="text-[11px] text-faint">当前仅支持中文</span>
          </div>

          <div className="mt-4 text-[12px] font-semibold text-muted">关于</div>
          <div className="mt-2 rounded-lg border border-line bg-surface px-3 py-3">
            <div className="flex items-center gap-2">
              ...
              <div className="leading-tight">
                <div className="text-[13px] font-semibold text-text">知库 sunnydoc</div>
                <div className="text-[11px] text-faint">以文档为核心的私有知识库</div>
              </div>
            </div>
          </div>
        </div>
