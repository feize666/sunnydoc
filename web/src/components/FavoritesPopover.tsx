...
export function FavoritesPopover({
  ...
  return (
    <>
      ...
      <div className="anim-slide-down-in fixed right-6 top-16 z-50 flex max-h-[70vh] w-[340px] max-w-[90vw] flex-col overflow-hidden rounded-xl border border-line bg-background shadow-lg">
