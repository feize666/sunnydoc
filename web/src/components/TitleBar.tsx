      ...
      {onOpenNotifications && (
        <Tooltip content="通知">
          ...
          >
            ...
            {unreadCount ? (
              <span className="absolute -right-0.5 -top-0.5 grid h-4 min-w-4 place-items-center rounded-full bg-danger-solid px-1 text-[10px] font-semibold leading-none text-white">
