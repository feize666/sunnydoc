      ...
      >
        ...
        <div className="px-5 py-4">
          <input
            ...
            placeholder="请输入名称"
            className="w-full rounded-lg border border-line bg-background px-3 py-2 text-[14px] text-text outline-none focus:border-accent focus:ring-2 focus:ring-accent/20"
          />
          <button
            onClick={submit}
